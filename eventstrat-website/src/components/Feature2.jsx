...
const Feature2 = () => {
  return (
<div className="section w-[1280px] h-[1657.98px] relative" style={{ backgroundColor: 'white' }}>
  <div className="admin-panel w-[117.67px] h-6 left-[90px] top-[75.08px] absolute text-[#173fbd] text-base font-normal font-['Inter'] leading-normal">Admin Panel</div>
  <div className="heading w-[360px] h-[92.05px] left-[90px] top-[87.08px] absolute">
